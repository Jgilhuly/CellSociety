...
public class Sugarscape extends Simulation {
	...
	public void initialize() {
		...
		State actor = new DirectionalAutomaton(Color.web(myColorScheme
				.getString("teamA")), "actor", 3, true);

		// 0. amt. of sugar 1. sugarGrowBackRate 2. max capacity
		State empty = new ColorChangeIntState(Color.web(myColorScheme
				.getString("teamB")), "empty", 3, Color.web(myColorScheme
				.getString("teamB")), 0, MAX_SUGAR / 2);
